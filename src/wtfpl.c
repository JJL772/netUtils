...
int
wtfpl(struct wtfpl_opts* opts, wtfpl_result_t** result)
{
...
void
wtfpl_opts_init(wtfpl_opts_t* opts)
{
  opts->addr = 0;
  opts->samples = 50;
}
...
void
wtfpl_result_free(wtfpl_result_t* result)
{
